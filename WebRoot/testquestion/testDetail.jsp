...
<head>
  ...
  <title>试题详情</title>
  <!-- 试题详情    详情是  detail   n.	详述; （照片、绘画等的） 细部; 细目，琐碎; 各种细节;-->
</head>
<body>
<center>
        ...
        <td>
          ...
          <table class="tableEdit" style="width:780px;" cellspacing="0" border="0" cellpadding="0">
            ...
            <tr>
              ...
              <td class="tdEditLabel" align=left><input type="text" name="name" value=${testQuestion.course.name }></td>
              <td class="tdEditLabel" >章：</td>
              <td class="tdEditLabel"><input type="text" name="name" value=${testQuestion.chapter.name }></td>
              <td class="tdEditLabel" >小节：</td>
              <td class="tdEditLabel"><input type="text" name="name" value=${testQuestion.section.name }></td>
            </tr>

            <tr>
              <td class="tdEditLabel" Colspan=1 >知识点</td>
              <td class="tdEditContent"><input type="text" name="name" value=${testQuestion.knowledgePoint.name }></td>
              <td class="tdEditLabel" Colspan=1 >试题类型</td>
              <td class="tdEditContent"><input type="text" name="name" value=${testQuestion.type.name }></td>
              <td class="tdEditLabel" >难度</td>
              <td class="tdEditContent"><input type="text" name="name" value=${testQuestion.difficulty.name }></td>
            </tr>

            <tr>
              <td class="tdEditLabel" >区分度</td>
              <td class="tdEditContent"><input type="text" name="name" value=${testQuestion.differentiate }></td>
              <td class="tdEditLabel" >曝光次数</td>
              <td class="tdEditContent"><input type="text" name="name" value=${testQuestion.count }></td>
              <td class="tdEditLabel"  >答题时间</td>
              <td class="tdEditContent"><input type="text" name="name" value=${testQuestion.adviceTime }></td>
            </tr>
            <tr>
            ...
            <tr>
              <TD Colspan=6>
                <input type="text" name="name" value=${testQuestion.content }>
              </TD>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <TD Colspan=6>
                ...
                <c:if test="${!empty(testQuestion.result)}">
                  <input type="text" name="name" value=${testQuestion.result }>
